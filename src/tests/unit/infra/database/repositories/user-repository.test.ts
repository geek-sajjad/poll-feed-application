...
describe('UserRepository', () => {
  ...
  describe('findOneById', () => {
    test('Return null if user is not found', async () => {
      ...
      const { database, encryptor, databaseUserRepository } =
        mockDependencies();
  ...
  describe('findOneByEmailPassword', () => {
    test('Return null if user is not found', async () => {
      ...
      const userRepository = new UserRepository(database, encryptor);
      const user = await userRepository.findOneByEmailPassword(
        userEmail,
        'password',
      );
  ...
  describe('create', () => {
    const mockDependenciesWithQueryRunner = () => {
      ...
      queryRunner.manager.getRepository = jest
        .fn()
        .mockReturnValue(databaseUserRepository);
    ...
    test('Create user and return it', async () => {
      ...
      const { database, encryptor, databaseUserRepository } =
        mockDependenciesWithQueryRunner();
