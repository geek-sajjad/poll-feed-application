...
class UsersRouter extends BaseRouter {
  constructor(
    @inject(REQUEST_HANDLERS_DI_TYPES.CreateUserRequestHandler)
    private readonly createUserRequestHandler: IRequestHandler,
  ) {
    super();
  }
  ...
  setupRoutes() {
    this.router
      .route('/')
      .post(
        this.createUserRequestHandler.handler.bind(
          this.createUserRequestHandler,
        ),
      );
  }
}
